...
CDXProjectCore g_cDXProjectCore;
...
BOOL InitWindowExtraCallBack(void)
{
	...
	bRet = g_cDXProjectCore.DXProjectCoreInit();
	if (!bRet)
	{
		return FALSE;
	}
...
{
	g_cDXProjectCore.DXProjectCoreRelease();
}
...
{
	g_cDXProjectCore.DXProjectCoreUpdate();
	g_cDXProjectCore.DXProjectCoreRender();
}