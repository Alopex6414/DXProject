...
//------------------------------------------------------------------
extern BOOL ARMENIACA_CALLMODE Armeniaca_Process_IsProcessExistA(const char* strProcessName);
...
// @Describe: 检测进程是否存在(名称)(TRUE:进程存在, FALSE:进程不存在)
//------------------------------------------------------------------
extern BOOL ARMENIACA_CALLMODE Armeniaca_Process_IsProcessExistW(const wchar_t* strProcessName);
...
//------------------------------------------------------------------
extern BOOL ARMENIACA_CALLMODE Armeniaca_Process_StartProcessA(const char* strProcessName);
...
// @Describe: 启动进程(名称)(TRUE:启动进程成功, FALSE:启动进程失败)
//------------------------------------------------------------------
extern BOOL ARMENIACA_CALLMODE Armeniaca_Process_StartProcessW(const wchar_t* strProcessName);
...
//------------------------------------------------------------------
extern BOOL ARMENIACA_CALLMODE Armeniaca_Convert_A2W_Safe(const char* szArr, const wchar_t* wszArr, int nSize);
...
//------------------------------------------------------------------
extern BOOL ARMENIACA_CALLMODE Armeniaca_Convert_W2A_Safe(const wchar_t* wszArr, const char* szArr, int nSize);
...
//------------------------------------------------------------------
extern void ARMENIACA_CALLMODE Armeniaca_Convert_A2W_UnSafe(const char* szArr, wchar_t** ppwszArr);
...
//------------------------------------------------------------------
extern void ARMENIACA_CALLMODE Armeniaca_Convert_W2A_UnSafe(const wchar_t* wszArr, char** ppszArr);
...
// @Describe: 字符转换:ASCII转换Unicode(传入目标数组NULL指针,需要释放内存!)
//------------------------------------------------------------------
extern wchar_t* ARMENIACA_CALLMODE Armeniaca_Convert_A2W_UnSafe2(const char* szArr);
...
//------------------------------------------------------------------
extern char* ARMENIACA_CALLMODE Armeniaca_Convert_W2A_UnSafe2(const wchar_t* wszArr);
...
//------------------------------------------------------------------
extern BOOL ARMENIACA_CALLMODE Armeniaca_FilePath_GetModulePathA(const char* szArr, int nSize);
...
// @Describe: 文件路径:获取模块当前文件路径(TRUE:成功, FALSE:失败)
//------------------------------------------------------------------
extern BOOL ARMENIACA_CALLMODE Armeniaca_FilePath_GetModulePathW(const wchar_t* wszArr, int nSize);
...
//------------------------------------------------------------------
extern BOOL ARMENIACA_CALLMODE Armeniaca_FilePath_GetLocalPathA(const char* szArr, int nSize);
...
// @Describe: 文件路径:获取模块当前文件夹路径(TRUE:成功, FALSE:失败)
//------------------------------------------------------------------
extern BOOL ARMENIACA_CALLMODE Armeniaca_FilePath_GetLocalPathW(const wchar_t* wszArr, int nSize);
...
//--------------------------------------------------------------------------
extern BOOL ARMENIACA_CALLMODE Armeniaca_FilePath_GetParentPathA(const char* szArr, int nSize, int nDeep);
...
// @Describe: 文件路径:获取模块当前文件夹父级路径(TRUE:成功, FALSE:失败)
//--------------------------------------------------------------------------
extern BOOL ARMENIACA_CALLMODE Armeniaca_FilePath_GetParentPathW(const wchar_t* wszArr, int nSize, int nDeep);
...
//--------------------------------------------------------------------------
extern void ARMENIACA_CALLMODE Armeniaca_Time_GetLocalTime(SYSTEMTIME* pLocalTime);
...
//--------------------------------------------------------------------------
extern WORD ARMENIACA_CALLMODE Armeniaca_Time_GetLocalTime_Year();
...
//--------------------------------------------------------------------------
extern WORD ARMENIACA_CALLMODE Armeniaca_Time_GetLocalTime_Month();
...
//--------------------------------------------------------------------------
extern WORD ARMENIACA_CALLMODE Armeniaca_Time_GetLocalTime_Day();
...
//--------------------------------------------------------------------------
extern WORD ARMENIACA_CALLMODE Armeniaca_Time_GetLocalTime_Hour();
...
//--------------------------------------------------------------------------
extern WORD ARMENIACA_CALLMODE Armeniaca_Time_GetLocalTime_Minute();
...
//--------------------------------------------------------------------------
extern WORD ARMENIACA_CALLMODE Armeniaca_Time_GetLocalTime_Second();
